...
represents an object that can be picked up in a sphere radius. All objects
...
public abstract class PickUpSphere : Interactable
{
    ...
    void Awake()
    {
        ...
        {
            Debug.Log("No collider detected on sphere pickup!"); 
        }
